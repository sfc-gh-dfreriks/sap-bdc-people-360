...
const SUGGESTED_QUESTIONS = [
  ...
  'What is the attrition rate by division?',
  'What is the average salary by pay grade and gender?',
  'How many external hires did we make in the last year?',
  'Show headcount by generation and age band.',
  'Which departments have the most critical positions?',
  'What are the top termination reasons?',
  'What is the gender diversity by department?',
];

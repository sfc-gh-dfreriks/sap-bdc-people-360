#!/usr/bin/env bash
# ---------------------------------------------------------------------------
# Build the People 360 container image and push it to a Snowflake image
...
#
# The image is pushed to:  <registry_host>/<repo_path>/people_360:latest
...
IMAGE="${REGISTRY_HOST}/${REPO_PATH}/people_360:latest"
